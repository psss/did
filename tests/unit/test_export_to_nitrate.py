...
import tempfile
from tmt.export import convert_manual_instructions_to_export_sections
...
class NitrateExportAutomated(TestCase):
    def setUp(self):
        ...
        self.cwd = os.getcwd()
        self.dir_name = 'export_case_automated'
    ...
    def test_export_to_nitrate_step(self):
        ...
        step = convert_manual_instructions_to_export_sections(file_name)[0]
...
"""
    ...
    def test_export_to_nitrate_expect(self):
        ...
        expect = convert_manual_instructions_to_export_sections(file_name)[1]
        html_generated = """<b>Test</b>\
...
"""
    ...
    def test_export_to_nitrate_empty_file(self):
        ...
        self.assertIn(file_name, files)
        html = convert_manual_instructions_to_export_sections(file_name)
        html_generated = ('', '', '', '')
    ...
    def test_export_to_nitrate_setup_doesnt_exist(self):
        ...
        file_name = 'test.md'
        self.assertIn(file_name, files)
        cleanup = convert_manual_instructions_to_export_sections(file_name)[2]
        html_generated = ''
    ...
    def test_export_to_nitrate_cleanup_latest_heading(self):
        ...
        cleanup = convert_manual_instructions_to_export_sections(file_name)[3]
